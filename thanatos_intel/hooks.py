...
app_include_js=['/assets/thanatos_intel/js/bootstrap_jq.js?v=20260627b',
                ...
                '/assets/thanatos_intel/js/switchboard_call.js?v=20260722a',
                '/assets/thanatos_intel/js/cockpit_land.js?v=20260627b',
                '/assets/thanatos_intel/js/thanatos_shell.js?v=20260627b',
                '/assets/thanatos_intel/js/wallet_recovery_form.js?v=20260707a',
]
...
doctype_js={"Investigation Case": "public/js/office_open.js"}
...
scheduler_events={
 ...
 'daily':['thanatos_intel.news.ingestion.daily_case_digest',
          ...
          'thanatos_intel.ai.conversation_review.daily_digest',
          'thanatos_intel.ingest.whatsapp_send.scheduled_sync_template_status'],
