...
app_title='Thanatos Intelligence Platform'
app_version='0.1.0'
app_description='Romanian-law-first intelligence, due diligence and recovery platform'
app_author='THANATOS INVESTIGAZIONI S.R.L.'
app_author_email='info@thanatos.ro'
app_license='MIT'
app_icon='icon-bar-chart'
app_color='navy'
app_email='info@thanatos.ro'
app_docs='https://platform.thanatos.ro'
app_country='RO'
