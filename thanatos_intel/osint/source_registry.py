...
SOURCES = [
    ...
    dict(key="pwnedpasswords", name="Pwned Passwords (k-anon)", tier="free_auto",
         status="planned", category="breach", targets=["Hash"],
         connector=None, url="https://haveibeenpwned.com/Passwords",
         note="Verifica hash password senza key (range API)."),
    dict(key="overpass_nominatim", name="OpenStreetMap / Nominatim", tier="free_auto",
         status="planned", category="geo", targets=["Address"],
         connector=None, url="https://nominatim.openstreetmap.org",
         note="Geocoding e POI per area, no key — manca target Address."),
    ...
    dict(key="companies_house", name="Companies House UK", tier="free_key",
         status="needs_key", category="aziende", targets=["Company"],
         connector="thanatos_intel.osint.companies_house.kyb_lookup",
         needs="companies_house_api_key", url="https://find-and-update.company-information.service.gov.uk"),
    dict(key="greynoise", name="GreyNoise Community", tier="free_key", status="planned",
         category="cyber", targets=["IP"], connector=None,
         needs="greynoise_api_key", url="https://greynoise.io",
         note="Distingue rumore internet da attività targetizzata."),
    dict(key="otx", name="OTX AlienVault", tier="free_key", status="planned",
         category="cyber", targets=["IP", "Domain", "Hash"], connector=None,
         needs="otx_api_key", url="https://otx.alienvault.com"),
    dict(key="pulsedive", name="Pulsedive", tier="free_key", status="planned",
         category="cyber", targets=["IP", "Domain", "Url"], connector=None,
         needs="pulsedive_api_key", url="https://pulsedive.com"),
    dict(key="mapillary", name="Mapillary", tier="free_key", status="planned",
         category="geo", targets=["Address"], connector=None,
    ...
    dict(key="holehe", name="Holehe (email→social CLI)", tier="manual",
         status="planned", category="social", targets=["Email"], connector=None,
         url="https://github.com/megadose/holehe", note="Installabile per ampliare Email."),
    ...
    dict(key="exiftool", name="ExifTool (metadata CLI)", tier="manual",
         status="planned", category="immagini", targets=["File"], connector=None,
         url="https://exiftool.org", note="Locale; integrabile su upload evidenze."),
