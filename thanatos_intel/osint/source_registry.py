...
SOURCES = [
    ...
    dict(key="ipinfo", name="IPinfo", tier="free_auto", status="operational",
         category="cyber", targets=["IP"],
         connector="thanatos_intel.osint.engine.lookup_ipinfo",
         needs="ipinfo_token", url="https://ipinfo.io",
         note="Free no-key (rate limit basso); con ipinfo_token sale il limite."),
    ...
    dict(key="urlscan", name="urlscan.io", tier="free_auto", status="operational",
    ...
    dict(key="securitytrails", name="SecurityTrails", tier="paid", status="paid_only",
         ...
         note="Tier gratuito RIMOSSO 2026 (Recorded Future): solo piani a pagamento (Professional $500/mo). Usare RDAP/urlscan/viewdns per storico DNS."),
