...
SOURCES = [
    ...
    dict(key="exiftool", name="ExifTool (metadata)", tier="manual",
         status="needs_key", category="immagini", targets=["File"],
         connector="thanatos_intel.osint.free_sources.lookup_exiftool",
         url="https://exiftool.org", note="Connettore pronto; serve binario exiftool installato."),
